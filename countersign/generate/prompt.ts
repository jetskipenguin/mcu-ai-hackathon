...
Preserve the three demo interfaces: quiz-submit, discussion-initial-post, and student-record. Quiz submission is human-required with UV required. The initial discussion post is attested with AI use disclosed; its match.when is {"is_initial_post":true}. The student record is marked, masked for automation-suspected sessions, and revealed by student-record.unmask with UV required. Signals are advisory and must not become action blockers.
...
Required JSON shape:
{
 ...
 "defaults":{"class":"unrestricted","signals":<the supplied defaults.signals object>},
 "rules":[
  ...
  {"id":"student-record","match":{"route":"/record/*"},"class":"marking","markings":[
   ...
   "page_marking":"<supplied id>","mask_when":"automation-suspected",
